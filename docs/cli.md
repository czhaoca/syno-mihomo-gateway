...
status --json emits one flat object: {"verb","ok","exit_code","stack_state","mihomo_ip","dashboard_url", "checks":[{"name","value"},...]}. doctor --json emits {"verb","ok","exit_code","checks":[...]}. Exactly one object on stdout; logs never interleave.
